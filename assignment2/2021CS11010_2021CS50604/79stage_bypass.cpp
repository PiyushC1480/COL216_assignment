...
#include "./79_stage_with_bypass/pc_7_with.hpp"
#include "./79_stage_with_bypass/if_7_with.hpp"
#include "./79_stage_with_bypass/id_7_with.hpp"
#include "./79_stage_with_bypass/ex_7_with.hpp"
#include "./79_stage_with_bypass/wb_7_with.hpp"
#include "./79_stage_with_bypass/read_7_with.hpp"
...
void reset_mem(){
    ...
    dm_rm.open("reg_7_with.txt", fstream::out | fstream :: trunc);
    for(int i=0; i<32; i++){
        dm_rm << 0 << endl;
    }
    dm_rm.close();
...
// bypass =>  a -- for alu to rr forwarding
//            b -- for DM2 to rr forwarding
...
int main(){
    ...
    while(!ALU_state.is_end()){
        ...
        if(RR_state.check_stall()){
            ...
            if (bypass[0] != "n"){
                if (bypass[0] == "a"){
                    if (opr_types(ID_RR[Prg_Ctr.getPC()][0]) == 3){
                        if (ID_RR[Prg_Ctr.getPC()][2] == ID_RR[Prg_Ctr.getPC()-1][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][7] = EX_MEM[Prg_Ctr.getPC()+1][2];
                        }
                        else if (ID_RR[Prg_Ctr.getPC()][3] == ID_RR[Prg_Ctr.getPC()-1][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][8] = EX_MEM[Prg_Ctr.getPC()+1][2];
                        }
                    }
                    else if (ID_RR[Prg_Ctr.getPC()][0] != 19){
                        if (ID_RR[Prg_Ctr.getPC()][2] == ID_RR[Prg_Ctr.getPC()-1][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][7] = EX_MEM[Prg_Ctr.getPC()+1][2];
                        }
                        ...
                        else if (ID_RR[Prg_Ctr.getPC()][1] == ID_RR[Prg_Ctr.getPC()-1][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][8] = EX_MEM[Prg_Ctr.getPC()+1][2];
                        }
                    }
                    ...
                    if (opr_types(ID_RR[Prg_Ctr.getPC()][0]) == 3){
                        if (ID_RR[Prg_Ctr.getPC()][2] == ID_RR[Prg_Ctr.getPC()-3][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][7] = MEM_WB[Prg_Ctr.getPC()+1][1];
                        }
                        else if (ID_RR[Prg_Ctr.getPC()][3] == ID_RR[Prg_Ctr.getPC()-3][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][8] = MEM_WB[Prg_Ctr.getPC()+1][1];
                        }
                        else if (ID_RR[Prg_Ctr.getPC()][2] == ID_RR[Prg_Ctr.getPC()-2][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][7] = MEM_WB[Prg_Ctr.getPC()][1];
                        }
                        else if (ID_RR[Prg_Ctr.getPC()][3] == ID_RR[Prg_Ctr.getPC()-2][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][8] = MEM_WB[Prg_Ctr.getPC()][1];
                        }
                        else if (ID_RR[Prg_Ctr.getPC()][2] == ID_RR[Prg_Ctr.getPC()-1][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][7] = MEM_WB[Prg_Ctr.getPC()-1][1];
                        }
                        else if (ID_RR[Prg_Ctr.getPC()][3] == ID_RR[Prg_Ctr.getPC()-1][1])
                        ...
                        else if (ID_RR[Prg_Ctr.getPC()][1] == ID_RR[Prg_Ctr.getPC()-3][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][8] = MEM_WB[Prg_Ctr.getPC()+1][1];;
                        }
                        else if (ID_RR[Prg_Ctr.getPC()][2] == ID_RR[Prg_Ctr.getPC()-2][1])
                        ...
                        else if (ID_RR[Prg_Ctr.getPC()][1] == ID_RR[Prg_Ctr.getPC()-2][1])
                        {
                            RR_ALU[Prg_Ctr.getPC()+1][8] = MEM_WB[Prg_Ctr.getPC()][1];;
                        }
                        else if (ID_RR[Prg_Ctr.getPC()][2] == ID_RR[Prg_Ctr.getPC()-1][1])
        ...
        if (ID2_state.check_stall()){
            ...
            ID2_state.OP_code(ID_ID, Prg_Ctr.getPC(), ID_RR, bypass);
    ...
    // ======================================== LW-SW INSTRUCTIONS ===================================== //
        ...
        {
            cout << 1<<" "<<DM_DM[Prg_Ctr.getPC()-1][2]<<" "<<DM_DM[Prg_Ctr.getPC()-1][4];
        }
        else{
            cout<<0;
        }
